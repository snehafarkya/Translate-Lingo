      ...
      <div className="">
        ...
        <Form >
          ...
          <div className="section relative mt-10 flex md:flex-row flex-col items-center justify-between md:h-screen ">
            ...
            <div className="section-bg md:h-full md:w-[50%] flex flex-col justify-center items-center py-auto md:px-28 px-6 h-screen">
              <h2 className="pt-12 text-white md:text-5xl text-4xl">Connecting <span className="text-purple-300 uppercase">Globe</span>  by eliminating Language barrier...</h2>
