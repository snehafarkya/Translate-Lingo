          ...
          <img src={logo} alt="" className="md:hidden"/>
            ...
            <ol className="md:text-xl text-lg text-white list-decimal md:text-left text-justify pl-4 leading-[48px] ">
              <li className="md:my-2">
                Speak anything in English and let AI type it for you.
              </li>
              <li className="md:my-2">
                It doesn't end up to here! You can literally copy what AI typed
                for you 🌀{" "}
              </li>
              <li className="md:my-2">You can reset or stop the listener </li>
            </ol>
            <a href="#formm">
              <button className="md:hidden mt-6 transition ease-in-out duration-200 bg-purple-700 text-white px-8 py-4 hover:shadow-lg hover:bg-white hover:text-purple-700 border-transparent border-2 hover:border-purple-700 flex gap-1 justify-center items-center rounded-lg">
                Try here{" "}
              </button>
            </a>
