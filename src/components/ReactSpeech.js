    ...
    <>
      <div className="h-screen w-screen flex flex-col back ">
        ...
        <div className="section relative grid md:grid-cols-2 grid-cols-1 items-center h-auto md:h-screen ">
            ...
            <div className="section-bg md:h-full flex flex-col md:justify-center items-center py-auto md:px-28 px-6 pb-24 h-screen">
              <h2 className="pt-24 text-white md:text-5xl text-5xl">Connecting <span className="text-purple-300 uppercase">Globe</span>  by eliminating Language barrier...</h2>
              <p className="md:text-2xl text-xl text-white text-center mt-4">Welcome to <span className="text-purple-300 uppercase font-bold">TranslateLingo</span>! Here you can:</p>
